...
- **Face Recognition**: Implements computer vision and machine learning to accurately recognize visitor faces.
- **Admin Notification**: Alerts the admin when a visitor is detected outside the entry point.
- **Admin Decision**: Enables admins to approve or deny visitor entry via WhatsApp.
- **Visitor Notification**: Instantly informs visitors of the admin's decision through WhatsApp messages.
- **Data Management**: Visitor data is stored in **Microsoft Excel** format for easy access and management.
...
- **Tkinter**: Provides the graphical user interface for the desktop application.
